...
export const setData = async () => {
    ...
    if (!users.length) {
        const responseUsers = await axios.get('https://62ec493c818ab252b6fa39a4.mockapi.io/api/v1/Worker');
        let arrayClient = [];
        let arrayWorker = [];
...
export const setOffers = async () => {
    ...
    if (!offers.length) {
        ...
        const responseOffers = await axios.get('https://62ec493c818ab252b6fa39a4.mockapi.io/api/v1/Offer');
        let arrayOffers = [];
...
export const setProposals = async () => {
    ...
    if (!proposals.length) {
        ...
        const responseProposal = await axios.get('https://62ec493c818ab252b6fa39a4.mockapi.io/api/v1/Offer');
        let arrayProposal = [];
...
export const setPortfolios = async () => {
    ...
    if (!portfolios.length) {
        let workersId = await UserWorker.findAll();
        const responsePortfolio = await axios.get('https://62ec493c818ab252b6fa39a4.mockapi.io/api/v1/Portfolio');
        let arrayPortfolio = [];
...
export const setReview = async () => {
    ...
    if (!reviews.length) {
        ...
        let clientsId = await UserClient.findAll();
        let offersId = await Offer.findAll();
        const responseReview = await axios.get('https://62ec493c818ab252b6fa39a4.mockapi.io/api/v1/Review');
        let arrayReview = [];
